...
const alertVariants = cva("relative w-full rounded-xl border p-4 shadow-sm transition-all duration-200 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground animate-fade-in", {
    variants: {
        variant: {
...
const Alert = React.forwardRef(({ className, variant, children, ...props }, ref) => {
    ...
    return (_jsxs("div", { ref: ref, role: "alert", className: cn(alertVariants({ variant }), className), ...props, children: [Icon && _jsx(Icon, { className: "h-5 w-5", "aria-hidden": "true" }), children] }));
});
