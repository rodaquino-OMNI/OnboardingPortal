...
class GamificationBadgeSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $badges = [
            ...
            // Mental Health & Risk Assessment Badges
            [
                'name' => 'Campeão do Bem-Estar',
                'slug' => 'wellness-champion',
                'description' => 'Completou a avaliação de saúde com indicadores de baixo risco',
                'icon_name' => 'trophy',
                'icon_color' => '#10B981',
                'category' => 'health',
                'rarity' => 'rare',
                'points_value' => 200,
                'criteria' => json_encode(['questionnaire_type' => 'unified', 'risk_level' => 'low']),
                'is_active' => true,
                'is_secret' => false,
                'sort_order' => 13,
                'created_at' => $now,
            ...
            [
                'name' => 'Consciência em Saúde',
                'slug' => 'health-awareness',
                'description' => 'Demonstrou consciência sobre sua saúde ao completar a avaliação',
                'icon_name' => 'lightbulb',
                'icon_color' => '#F59E0B',
                'category' => 'health',
                'rarity' => 'uncommon',
                'points_value' => 150,
                'criteria' => json_encode(['questionnaire_type' => 'unified', 'risk_level' => 'moderate']),
                'is_active' => true,
                'is_secret' => false,
                'sort_order' => 14,
                'created_at' => $now,
            ...
            [
                'name' => 'Defensor da Saúde',
                'slug' => 'health-advocate',
                'description' => 'Tomou uma atitude importante ao buscar avaliação de saúde',
                'icon_name' => 'shield',
                'icon_color' => '#EF4444',
                'category' => 'health',
                'rarity' => 'epic',
                'points_value' => 250,
                'criteria' => json_encode(['questionnaire_type' => 'unified', 'risk_level' => ['high', 'critical']]),
                'is_active' => true,
                'is_secret' => false,
                'sort_order' => 15,
                'created_at' => $now,
            ...
            [
                'name' => 'Campeão do Bem-Estar Mental',
                'slug' => 'mental-wellness-champion',
                'description' => 'Completou a avaliação de saúde mental com sucesso',
                'icon_name' => 'brain',
                'icon_color' => '#7C3AED',
                'category' => 'health',
                'rarity' => 'rare',
                'points_value' => 300,
                'criteria' => json_encode(['completed_domain' => 'mental_health']),
                'is_active' => true,
                'is_secret' => false,
                'sort_order' => 16,
                'created_at' => $now,
            ...
            [
                'name' => 'Estilo de Vida Consciente',
                'slug' => 'lifestyle-conscious',
                'description' => 'Completou a avaliação de estilo de vida e hábitos',
                'icon_name' => 'leaf',
                'icon_color' => '#10B981',
                'category' => 'health',
                'rarity' => 'uncommon',
                'points_value' => 200,
                'criteria' => json_encode(['completed_domain' => 'lifestyle']),
                'is_active' => true,
                'is_secret' => false,
                'sort_order' => 17,
                'created_at' => $now,
            ...
            [
                ...
                'slug' => 'telemedicine_pioneer',
                'description' => 'Primeira consulta de telemedicina como recompensa por completar o onboarding',
                'icon_name' => 'video-camera',
                'icon_color' => '#0EA5E9',
                'category' => 'telemedicine',
                'rarity' => 'epic',
                'points_value' => 300,
                'criteria' => json_encode(['telemedicine_first_appointment' => true, 'completion_reward' => true]),
                'is_active' => true,
                'is_secret' => false,
                'sort_order' => 50,
                'created_at' => $now,
            ...
            [
                'name' => 'Especialista em Telemedicina',
                'slug' => 'telemedicine_expert', 
                'description' => 'Completou 5 consultas de telemedicina com sucesso',
                'icon_name' => 'user-graduate',
                'icon_color' => '#7C3AED',
                'category' => 'telemedicine',
                'rarity' => 'legendary',
                'points_value' => 500,
                'criteria' => json_encode(['telemedicine_appointments_completed' => 5]),
                'is_active' => true,
                'is_secret' => false,
                'sort_order' => 51,
                'created_at' => $now,
            ...
            [
                'name' => 'Preparação Exemplar',
                'slug' => 'telemedicine_preparation',
                'description' => 'Completou perfeitamente o checklist de preparação para telemedicina',
                'icon_name' => 'check-circle',
                'icon_color' => '#10B981',
                'category' => 'telemedicine',
                'rarity' => 'rare',
                'points_value' => 150,
                'criteria' => json_encode(['telemedicine_preparation_perfect' => true]),
                'is_active' => true,
                'is_secret' => false,
                'sort_order' => 52,
                'created_at' => $now,
