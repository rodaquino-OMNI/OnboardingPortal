...
// PERFORMANCE OPTIMIZATION: Memoize formatValue function to prevent recreation on every render
...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className, type, mask, onChange, icon: Icon, error, ...props }, ref) => {
    // PERFORMANCE OPTIMIZATION: Memoize handleChange to prevent recreation on every render
    ...
    // PERFORMANCE OPTIMIZATION: Memoize computed class names
