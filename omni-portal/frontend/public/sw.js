// Service Worker for Omni Portal
// Version 1.0.0

const CACHE_NAME = 'omni-portal-v1';
const STATIC_CACHE = 'omni-portal-static-v1';
const DYNAMIC_CACHE = 'omni-portal-dynamic-v1';
const API_CACHE = 'omni-portal-api-v1';
...
async function doBackgroundSync() {
  ...
  // This could retry failed API requests when online
}
...
self.addEventListener('push', (event) => {
  ...
  event.waitUntil(
    self.registration.showNotification('Omni Portal', options)
  );
});
